...
const Footer = () => {
  return (
    <div className='border-t-8 border-dashed'>
      <div className="container grid grid-cols-1 md:grid-cols-2 py-20">
        ...
        <div className="flex flex-col gap-7">
          ...
          <div className="flex items-center gap-3">
            <a href='/' className="px-7 py-3 rounded-full text-base font-medium text-neutral-50 bg-gradient-to-r from-cyan-500 to-blue-500 hover:animate-pulse">
                Buy on OpenSea
            </a>
            <a href='/' className=' border-2 border-neutral-50 px-7 py-2 rounded-full text-base font-semibold hover:text-neutral-50 hover:bg-zinc-800 bg-neutral-50 text-zinc-800'>
              Join our Discord
        ...
        <div className="flex flex-col">
          ...
          <p className='text-sm font-semibold mt-auto'>© 2021 BORED BUNNY. ALL RIGHTS RESERVED</p>
        </div>
