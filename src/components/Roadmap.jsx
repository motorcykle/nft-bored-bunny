      ...
      <div className="container py-24 relative z-50">
        ...
        <div className="steps text-neutral-100 py-10 flex flex-col gap-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
            ...
            <div className="md:border-r-2 pr-3 py-3 rounded-3xl">
              <h3 className='text-3xl mb-2'>• First Part</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
            ...
            <div className="md:border-l-2 pl-3 py-3 rounded-3xl">
              <h3 className='text-3xl mb-2'>• Launch of our Merch & Exclusive Event</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
            ...
            <div className="md:border-r-2 pr-3 py-3 rounded-3xl">
              <h3 className='text-3xl mb-2'>• Funding Time & Breeding Unlock</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
            ...
            <div className="md:border-l-2 pl-3 py-3 rounded-3xl">
              <h3 className='text-3xl mb-2'>• Bored Bunny City</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
            ...
            <div className="md:border-r-2 pr-3 py-3 rounded-3xl">
              <h3 className='text-3xl mb-2'>• Bored Bunny Over The World</h3>
